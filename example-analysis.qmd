...
This plot is animated to show each contestants trajectory.  While the series winner doesn't always rank first, a last-place ranking often means the end of the journey, and elimination that week, for a contestant.


::: {.column-margin}
In Series 1 - Episode 1, BBC did not air the judges' discussion of all the Technical Challenge rankings; viewers only learned the top 3 and bottom 3. For the Series 1 contestants that fell in the middle, our graph starts with their ranking in Episode 2.
:::
...
ggplot(tech_results, aes(x = episode, y = technical, group = baker_unique, color=series)) +
  ...
  labs(
    ...
    subtitle = "Though it is one of 3 challenges, a last place finish in the Technical Challenge often means\n elimination that week",
    caption  = "Data Source: {bakeoff} package",
    x = "Episodes →",
    y = "Technical Challenge Ranking"
  ) +
